...
matrix[N2, M] lp2 = rep_matrix(0,N2,M);
{
  ...
  prediction[1:N0,m] = rep_vector(y[m],N0); // learn the number of cases in the first N0 days
               ...
               for (i in 1:N2){
                 ...
                 lp2[i,m]=spline1[i,m]*beta_1[m]+spline2[i,m]*beta_2[m]+spline3[i,m]*beta_3[m]+spline4[i,m]*beta_4[m]+contacts[i,m]*beta_5[m];
...

{
  ...
  prediction7[1:N0,m] = rep_vector(y[m],N0); // learn the number of cases in the first N0 days
               ...
               for (i in 1:N2){
                 ...
                 lp2_7[i,m]=spline1[i,m]*beta_1[m]+spline2[i,m]*beta_2[m]+spline3[i,m]*beta_3[m]+spline4[i,m]*beta_4[m]-0.5*beta_5[m];
  ...
  prediction0[1:N0,m] = rep_vector(y[m],N0); // learn the number of cases in the first N0 days
               ...
               for (i in 1:N2){
              lp2_0[i,m]=spline1[i,m]*beta_1[m]+spline2[i,m]*beta_2[m]+spline3[i,m]*beta_3[m]+spline4[i,m]*beta_4[m]+contacts[i,m]*beta_5[m];
  ...
  prediction5[1:N0,m] = rep_vector(y[m],N0); // learn the number of cases in the first N0 days
               ...
               for (i in 1:N2){
              lp2_5[i,m]=spline1[i,m]*beta_1[m]+spline2[i,m]*beta_2[m]+spline3[i,m]*beta_3[m]+spline4[i,m]*beta_4[m]-0.5*beta_5[m];
  ...
  prediction1[1:N0,m] = rep_vector(y[m],N0); // learn the number of cases in the first N0 days
               ...
               for (i in 1:N2){
                 ...
                 lp2_1[i,m]=spline1[i,m]*beta_1[m]+spline2[i,m]*beta_2[m]+spline3[i,m]*beta_3[m]+spline4[i,m]*beta_4[m]+contacts[i,m]*beta_5[m];
  ...
  prediction6[1:N0,m] = rep_vector(y[m],N0); // learn the number of cases in the first N0 days
               ...
               for (i in 1:N2){
                 ...
                 lp2_6[i,m]=spline1[i,m]*beta_1[m]+spline2[i,m]*beta_2[m]+spline3[i,m]*beta_3[m]+spline4[i,m]*beta_4[m]-0.5*beta_5[m];
  ...
  prediction2[1:N0,m] = rep_vector(y[m],N0); // learn the number of cases in the first N0 days
               ...
               for (i in 1:N2){
                 ...
                 lp2_2[i,m]=spline1[i,m]*beta_1[m]+spline2[i,m]*beta_2[m]+spline3[i,m]*beta_3[m]+spline4[i,m]*beta_4[m]+contacts[i,m]*beta_5[m];
  ...
  prediction8[1:N0,m] = rep_vector(y[m],N0); // learn the number of cases in the first N0 days
               ...
               for (i in 1:N2){
                 ...
                 lp2_8[i,m]=spline1[i,m]*beta_1[m]+spline2[i,m]*beta_2[m]+spline3[i,m]*beta_3[m]+spline4[i,m]*beta_4[m]-0.5*beta_5[m];
  ...
  prediction3[1:N0,m] = rep_vector(y[m],N0); // learn the number of cases in the first N0 days
               ...
               for (i in 1:N2){
                 ...
                 lp2_3[i,m]=spline1[i,m]*beta_1[m]+spline2[i,m]*beta_2[m]+spline3[i,m]*beta_3[m]+spline4[i,m]*beta_4[m]+contacts[i,m]*beta_5[m];
  ...
  prediction9[1:N0,m] = rep_vector(y[m],N0); // learn the number of cases in the first N0 days
               ...
               for (i in 1:N2){
                 ...
                 lp2_9[i,m]=spline1[i,m]*beta_1[m]+spline2[i,m]*beta_2[m]+spline3[i,m]*beta_3[m]+spline4[i,m]*beta_4[m]-0.5*beta_5[m];
  ...
  prediction4[1:N0,m] = rep_vector(y[m],N0); // learn the number of cases in the first N0 days
               ...
               for (i in 1:N2){
                 ...
                 lp2_4[i,m]=spline1[i,m]*beta_1[m]+spline2[i,m]*beta_2[m]+spline3[i,m]*beta_3[m]+spline4[i,m]*beta_4[m]+contacts[i,m]*beta_5[m];
  ...
  prediction10[1:N0,m] = rep_vector(y[m],N0); // learn the number of cases in the first N0 days
               ...
               for (i in 1:N2){
                 ...
                 lp2_10[i,m]=spline1[i,m]*beta_1[m]+spline2[i,m]*beta_2[m]+spline3[i,m]*beta_3[m]+spline4[i,m]*beta_4[m]-0.5*beta_5[m];
  ...
  prediction11[1:N0,m] = rep_vector(y[m],N0); // learn the number of cases in the first N0 days
               ...
               for (i in 1:N2){
                 ...
                 lp2_11[i,m]=spline1[i,m]*beta_1[m]+spline2[i,m]*beta_2[m]+spline3[i,m]*beta_3[m]+spline4[i,m]*beta_4[m]+contacts[i,m]*beta_5[m];
  ...
  prediction12[1:N0,m] = rep_vector(y[m],N0); // learn the number of cases in the first N0 days
               ...
               for (i in 1:N2){
                 ...
                 lp2_12[i,m]=spline1[i,m]*beta_1[m]+spline2[i,m]*beta_2[m]+spline3[i,m]*beta_3[m]+spline4[i,m]*beta_4[m]-0.5*beta_5[m];
  ...
  prediction13[1:N0,m] = rep_vector(y[m],N0); // learn the number of cases in the first N0 days
               ...
               for (i in 1:N2){
                 ...
                 lp2_13[i,m]=spline1[i,m]*beta_1[m]+spline2[i,m]*beta_2[m]+spline3[i,m]*beta_3[m]+spline4[i,m]*beta_4[m]+contacts[i,m]*beta_5[m];
  ...
  prediction14[1:N0,m] = rep_vector(y[m],N0); // learn the number of cases in the first N0 days
               ...
               for (i in 1:N2){
                 ...
                 lp2_14[i,m]=spline1[i,m]*beta_1[m]+spline2[i,m]*beta_2[m]+spline3[i,m]*beta_3[m]+spline4[i,m]*beta_4[m]-0.5*beta_5[m];
  ...
  prediction15[1:N0,m] = rep_vector(y[m],N0); // learn the number of cases in the first N0 days
               ...
               for (i in 1:N2){
                 ...
                 lp2_15[i,m]=spline1[i,m]*beta_1[m]+spline2[i,m]*beta_2[m]+spline3[i,m]*beta_3[m]+spline4[i,m]*beta_4[m]+contacts[i,m]*beta_5[m];
  ...
  prediction16[1:N0,m] = rep_vector(y[m],N0); // learn the number of cases in the first N0 days
               ...
               for (i in 1:N2){
                 ...
                 lp2_16[i,m]=spline1[i,m]*beta_1[m]+spline2[i,m]*beta_2[m]+spline3[i,m]*beta_3[m]+spline4[i,m]*beta_4[m]-0.5*beta_5[m];
